...
verifyReportsImagesandLinksList() {
    ...
    cy.get(shared_locators.firstSliderLink).should('have.attr', 'href').and('include', '/product/astrology-plus');
    cy.get(shared_locators.secondSliderReport).should('be.visible');
    cy.get(shared_locators.secondSliderLink).should('have.attr', 'href').and('include', '/product/september-2021-horoscope');
